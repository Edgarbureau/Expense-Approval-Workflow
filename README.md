...
This is an n8n workflow that automates an employee expense claim from submission to approval to the accounting entry, and no manual data entry after the form is submitted.

The Problem
Manually, this process will look like: employee messages a receipt > manager reviews and replies informally > someone re-types it into accounting software > someone else updates a spreadsheet separately to track it. Anytime there is a handoff, there is a probability of information getting lost.

What It Does
1. Employee submits an expense (vendor, amount, category, receipt) via a Google Form.
![Google Form](Google%20Form%201.jpeg)
![Google Form](Google%20Form%202.jpeg)
...
![Manager Email](Manager%20Email.jpeg)
...
![Approved, Pending or Declined](Approved%2C%20Pending%20or%20Declined.jpeg)

The Full Workflow
![Full Workflow](Full%20Workflow.jpeg)
...
![Pending Approval or Rejection](Pending%20Approval%20or%20Rejection.jpeg)
...
![Receipt in Xero](Reciept%20in%20Xero.jpeg)
